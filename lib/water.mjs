...
export const STATIONS=Object.freeze({
  iwabuchi:Object.freeze({
    key:'iwabuchi',name:'岩淵水門',id:'303041283309040',
  ...
  chisuibashi:Object.freeze({
    ...
    thresholds:Object.freeze({standby:7.00,advisory:7.50,evacuation:12.80,danger:13.30,plan:14.60}),chartMax:14
  }),
  kumagaya:Object.freeze({
    ...
    thresholds:Object.freeze({standby:3.00,advisory:3.50,evacuation:5.00,danger:5.50,plan:7.51}),chartMax:6
  })
});
